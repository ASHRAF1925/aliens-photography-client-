...
const ServiceDetails = () => {
  ...
  // useEffect(()=>{
  //   fetch(`https://aliens-photography-server-ashraf1925.vercel.app/services/${params.id}`
  // },[])
  ...
  const handleAddComment = (event) => {
    ...
    console.log(newComment);
      ...
      fetch("https://aliens-photography-server-ashraf1925.vercel.app/services/reviews",{
        method:'POST',
        headers:{
  ...
  useEffect(() => {
    fetch(`https://aliens-photography-server-ashraf1925.vercel.app/services/reviews/${Singleservice._id}`)
