...
const MyReview = () => {
  ...
  useEffect(() => {
    fetch(`https://aliens-photography-server-ashraf1925.vercel.app/services/user/review?email=${user.email}`, {
      headers: {
  ...
  const handleDelete = (review) => {
    ...
    if (agree) {
      fetch(`https://aliens-photography-server-ashraf1925.vercel.app/reviews/${review._id}`, {
        method: "DELETE",
      })
        .then((res) => res.json())
        .then((data) => {
